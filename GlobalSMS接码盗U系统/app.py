...
from models import db, Country, User, Service, CountryService, PhoneNumber, Order, LoginRecord
...
def check_user_auth():
    ...
    public_routes = ['login', 'register', 'static', 'index', 'recharge_usdt_page', 'check_payment', 'config', 'config_login', 'config_logout', 'contact']
